...
namespace GenxAi_Solutions_V1.Utils
{
    ...
    "- Always respond with only Microsoft SQL server query if user ask to display data in chart/graph.\n\n" +
    "Example format:\n" +
 ...
 "- Always respond with only Microsoft SQL server query if user ask to display data in chart/graph.\n\n" +
 "- Make casual conversation with user if user ask question regarding past questions.\n\n" +
 "Example format:\n" +

...
namespace GenxAi_Solutions_V1.Api
{
    ...
    public class CompanyOnboardController : ControllerBase
    {
       ...
       // private readonly ILogger<SQLiteVectorStore> _sqliteLogger;
        ...
        private readonly IVectorStoreFactory _svcFacory;
    ...
    [FromForm] FileAnalyticsCreate_req request)   // <-- switched to [FromForm]
        ...
        //                var selectedSchemaEntries = new List<BOL.SchemaEntry>();
        ...
        //                    selectedSchemaEntries.Add(new BOL.SchemaEntry(s.TableName, schemaText.ToString(), emb));
        //                }
        ...
        //                var finalPromptSql = PromptService.AddUserInputInPrompt(chosenPrompt, message, new List<BOL.SchemaEntry>());
        //                Console.WriteLine("Prompt : " + finalPromptSql.ToString());
        //                tokensUsed += EstimateTokens(finalPromptSql);
